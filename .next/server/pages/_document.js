...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_1___default.a {
  ...
  render() {
    const gaSrc = `https://www.googletagmanager.com/gtag/js?id=${_lib_gtag__WEBPACK_IMPORTED_MODULE_2__[/* GA_TRACKING_ID */ "a"]}`;
    const gaScript = `window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','${_lib_gtag__WEBPACK_IMPORTED_MODULE_2__[/* GA_TRACKING_ID */ "a"]}',{page_path: window.location.pathname,});`;
...
const GA_TRACKING_ID = "G-W8QXXCK22W"; // https://developers.google.com/analytics/devguides/collection/gtagjs/pages
